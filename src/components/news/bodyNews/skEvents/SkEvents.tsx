                ...
                <div className={styles.category_main}>
                    <div className={styles.category_main_title}>
                        <span className={styles.span_text}>
                            <span className={styles.main_title}>Sự kiện</span>
                        </span>
                    </div>
                    <div className={styles.category_main_content}>
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/tocotoco-nhan-doi-su-ngot-ngao-mua-le-hoi/">
                            ...
                            <div className={styles.post_card_content}>
                                <div className={styles.post_card_title}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Cùng V-Milk Tea nhân đôi sự ngọt ngào mùa lễ hội</span>
                                    </span>
                                </div>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/tocotoco-nang-tam-gia-tri-nong-san-viet/">
                            ...
                            <div className={styles.post_card_content}>
                                <div className={styles.post_card_title}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Tâm huyết nâng tầm giá trị nông sản Việt của V-Milk Tea</span>
                                    </span>
                                </div>
                                <div className={styles.post_card_excerpt}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Theo zingnews.vn – Trong 8 năm phát triển, V-Milk Tea không ngừng theo đuổi sứ mệnh xây dựng một thương hiệu trà sữa từ nông sản Việt uy tín, chất lượng. […]</span>
                                    </span>
                                </div>
                                <div className={styles.button_type_one}>
                                    <span className={styles.span_text}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/choco-ngu-coc-kem-cafe-hong-tra-ngu-coc-kem-cafe/">
                            ...
                            <div className={styles.post_card_content}>
                                ...
                                <div className={styles.post_card_excerpt}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Ỏ, V-Milk Tea món gì mới đây ta?! Món gì mà là lạ, vừa có vị socola ngọt ngào, có vị hồng trà đậm đà, mà còn được kết hợp cùng […]</span>
                                    </span>
                                </div>
                                <div className={styles.button_type_one}>
                                    <span className={styles.span_text}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/khang-hang-thi-truong-my_ua-thich-tocotoco/">
                            ...
                            <div className={styles.post_card_content}>
                                <div className={styles.post_card_title}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Vì sao khách hàng tại thị trường Mỹ ưa thích vị đậm đà khác biệt của V-Milk Tea?</span>
                                    </span>
                                </div>
                                <div className={styles.post_card_excerpt}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Theo vietbao.vn – V-Milk Tea – thương hiệu trà sữa đã quen mặt với giới trẻ Việt Nam, đã vượt qua nhiều đối thủ để tự hào có mặt trên thị […]</span>
                                    </span>
                                </div>
                                <div className={styles.button_type_one}>
                                    <span className={styles.span_text}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/tin-tuc-hien-trang-chu/hanh-trinh-8-nam-chinh-phuc-khach-hang-cua-tocotoco/">
                            ...
                            <div className={styles.post_card_content}>
                                <div className={styles.post_card_title}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Hành trình 8 năm chinh phục khách hàng của V-Milk Tea</span>
                                    </span>
                                </div>
                                <div className={styles.post_card_excerpt}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Theo zingnews.vn – 8 năm không ngừng đổi mới và phát triển đưa V-Milk Tea từng bước trở thành thương hiệu trà sữa được hàng triệu khách hàng ưa chuộng.Không khó […]</span>
                                    </span>
                                </div>
                                <div className={styles.button_type_one}>
                                    <span className={styles.span_text}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/tocotoco-tra-sua-tien-phong-su-dung-nong-san-viet/">
                            ...
                            <div className={styles.post_card_content}>
                                <div className={styles.post_card_title}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>V-Milk Tea thay đổi quan niệm về nguồn nguyên liệu trà sữa tại Việt Nam</span>
                                    </span>
                                </div>
                                <div className={styles.post_card_excerpt}>
                                    <span className={styles.span_text}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/tin-tuc-hien-trang-chu/8-nam-phat-trien-vung-manh/">
                            ...
                            <div className={styles.post_card_content}>
                                <div className={styles.post_card_title}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>V-Milk Tea – 8 năm gắn kết phát triển vững mạnh cùng Đối tác</span>
                                    </span>
                                </div>
                                <div className={styles.post_card_excerpt}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Theo báo Hội Nhập – Trải qua năm 2021 với nhiều khó khăn giữa đại dịch, V-Milk Tea kỉ niệm sinh nhật lần thứ 8, đánh dấu chặng đường phát triển […]</span>
                                    </span>
                                </div>
                                <div className={styles.button_type_one}>
                                    <span className={styles.span_text}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/tocotoco-bat-mi-cach-san-iphone-13-pro-max/">
                            ...
                            <div className={styles.post_card_content}>
                                <div className={styles.post_card_title}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>V-Milk Tea bật mí cách săn iPhone 13 Pro Max</span>
                                    </span>
                                </div>
                                <div className={styles.post_card_excerpt}>
                                    <span className={styles.span_text}>
                                        <span className={styles.span_text}>Không cần thắt lưng buộc bụng, V-Milk Tea đem đến cho bạn cơ hội sở hữu iPhone 13 Pro Max hàng tuần đến hết 20/12, kèm theo hàng nghìn quà tặng […]</span>
                                    </span>
                                </div>
                                <div className={styles.button_type_one}>
                                    <span className={styles.span_text}>
